...
public class ImgHist {
	...
	private int[][] imgMatrixBinary;
	
	private int[] imgHist;
	private int[] imgHistEqal;
	private int[] imgHistBinary;
	...
	public ImgHist(String fileName) throws IOException{
		...
		this.imgMatrixBinary = this.genMatrix(this.optBinaryImg);
		this.imgHistBinary = this.genHistogram(imgMatrixBinary);
		
		//this.imgHistBinary = this.genHistogramEqal(this.genHistogram(this.genMatrix(this.optBinaryImg)));
	}
	...
	public BufferedImage getOptimalBinaryImage(){
